module.exports = {
  ...
  SupportServer: "https://discord.gg/HMMM", //Support Server Link
  ...
  CookieSecret: "I use arch btw", //A Secret like a password
  IconURL:
  ...
  Lavalink: {
    ...
    host: "hosting.org", //- The host name or IP of the lavalink server.
    port: 2124, // The port that lavalink is listening to. This must be a number!
    pass: "gentoo", //- The password of the lavalink server.
